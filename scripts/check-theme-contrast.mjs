...
const checks = [
  ...
  ['texto sobre linha em hover', palette.navy, palette.tableHover, 4.5],
  ['link sobre linha em hover', palette.orangeHoverText, palette.tableHover, 4.5],
